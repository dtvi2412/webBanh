                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">Hóa đơn
                            <small>Danh sách đang giao</small>
                        </h1>
                    </div>
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX" align="center">
                                ...
                                <td>{{$b->note}}</td>
                                <td>@if($b->status == 1){{"Đang giao"}} @endif</td>
                                <td>@if($b->status == 1) <a href="admin/bill/duyetdanhsachdanggiao/{{$b->id}}"><input type="button" name="" value="Đã giao"></a>@endif</td>
